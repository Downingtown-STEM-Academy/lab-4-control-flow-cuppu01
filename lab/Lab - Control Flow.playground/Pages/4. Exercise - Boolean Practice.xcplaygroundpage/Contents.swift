...
//insert print statements here!!
    print("I will go outside to walk")
}else{
    print("I will not go outside to walk")
}
print("For the first set: I will walk outside.")
print("I will not go for a walk for the second set")
print("I will go for a walk for the third set")
